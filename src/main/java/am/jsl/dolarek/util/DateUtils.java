...
import static am.jsl.dolarek.util.Constants.DATE_FORMAT;
import static am.jsl.dolarek.util.Constants.DATE_TIME_FORMAT;
...
public class DateUtils {
  ...
  public static final DateFormat DATE_TIME_FORMATTER = new SimpleDateFormat(
    DATE_TIME_FORMAT
  );
  ...
  public static Timestamp convert(LocalTime localTime) {
    return localTime == null
      ? null
      : Timestamp.valueOf(localTime.atDate(LocalDate.ofEpochDay(0)));
  }
  ...
  public static Date parseDateTime(String dateTime) throws ParseException {
    return TextUtils.isEmpty(dateTime)
      ? null
      : DATE_TIME_FORMATTER.parse(dateTime);
  }

  public static LocalDateTime parse(String localDateTime) {
    return TextUtils.isEmpty(localDateTime)
      ? null
      : LocalDateTime.parse(localDateTime, LOCAL_DATE_TIME_FORMATTER);
  }
