...
public class RootConfig {
  ...
  public JobDetail databaseDumpJobDetail() {
    ...
    return JobBuilder
      .newJob(DatabaseDumpJob.class)
      .withIdentity("databaseDumpJob")
      .setJobData(new JobDataMap(jobDataAsMap))
      .storeDurably()
      .build();
  }
  ...
  public Trigger databaseDumpJobTrigger() {
    ...
    return TriggerBuilder
      .newTrigger()
      .forJob(databaseDumpJobDetail())
      .withIdentity("databaseDumpJobTrigger")
