...
import am.jsl.dolarek.web.converter.StringToLocalDateTimeConverter;
import am.jsl.dolarek.web.dialect.DolarekDialect;
import am.jsl.dolarek.web.format.RoleFormatter;
import am.jsl.dolarek.web.interceptor.UserInterceptor;
...
public class SpringWebConfig implements WebMvcConfigurer {
  ...
  @Value("${dolarek.user.img.dir}")
  private String userImgDir;

  @Value("${dolarek.user.html.dir}")
  ...
  public void configureDefaultServletHandling(
    ...
    configurer.enable("dolarekDefaultServlet");
  }
  ...
  /**
   * Tworzy niestandardowe {@link DolarekDialect} używane na stronach thymeleaf.
   *
   * @return Dialekt Dolarek
   */
  @Bean
  public DolarekDialect dolarekDialect() {
    return new DolarekDialect();
  }
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry) {
    ...
    registry
      .addResourceHandler(Constants.USER_IMG_PATHPATTERN)
      .addResourceLocations("file:" + userImgDir);
    registry
      .addResourceHandler(Constants.USER_HTML_PATHPATTERN)
      .addResourceLocations("file:" + userHtmlDir);
  }
  ...
  public void addInterceptors(InterceptorRegistry registry) {
    ...
    registry
      ...
      .addPathPatterns(Constants.USER_HTML_PATHPATTERN);
  }
