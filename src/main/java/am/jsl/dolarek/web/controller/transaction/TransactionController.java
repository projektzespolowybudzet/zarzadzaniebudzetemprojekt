package am.jsl.dolarek.web.controller.transaction;
...
import am.jsl.dolarek.web.form.TransactionSearchForm;
...
public class TransactionController extends BaseController {
  ...
  public static final String FORWARD_TRANSACTION_LIST =
    "transaction/transaction-list";
  public static final String FORWARD_TRANSACTION_RESULT_LIST =
    "transaction/transaction-list-result :: transactionResultsList";
  public static final String FORWARD_TRANSACTION_VIEW =
    "transaction/transaction-view :: transactionFormDiv";
  public static final String FORWARD_TRANSACTION_MANAGE =
    "transaction/transaction-manage :: transactionFormDiv";
  public static final String FORWARD_TRANSACTION_ADD_BATCH =
    "transaction/transaction-add-batch :: transactionFormDiv";
  ...
  public String loadTransactions(
    ...
    PageWrapper<TransactionListDTO> pageWrapper = new PageWrapper<>(
      paginatedResult,
      page,
      size
    );
  ...
  public String save(@Valid @ModelAttribute TransactionDTO transactionDTO)
    throws Exception {
  ...
  public String addBatch(
    @ModelAttribute AddTransactionsDTO addTransactionsDTO
  ) {
  ...
  public String view(
    ...
    if (!model.containsAttribute(TRANSACTION)) {
      User user = getUser();
      long userId = user.getId();
      TransactionDetailsDTO transaction = transactionService.getDetails(
        id,
        userId
      );
