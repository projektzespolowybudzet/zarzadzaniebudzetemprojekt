...
public class EventController extends BaseController {
  ...
  public static final String FORWARD_EVENT_RESULT_LIST =
    "system/event/event-list-result :: eventResultsList";
  ...
  /**
   * Wywołany gdy admin otwiera stronę listy zdarzeń.
   *
   * @param model Model
  ...
  /**
   * Wywołany metodą AJAX do wyszukiwania i stronicowania zdarzeń.
   *
   * @param model Model
  ...
  public String loadEvents(
    ...
    PageWrapper<EventListDTO> pageWrapper = new PageWrapper<>(
      result,
      page,
      Constants.PAGE_SIZE
    );
