...
public class AccountController extends BaseController {
  ...
  public static final String FORWARD_ACCOUNT_LOOKUP_LIST =
    "account/account-lookup-result :: accountLookupList";
  ...
  public String add(
    ...
    String message = i18n.msg(
      request,
      I18n.KEY_MESSAGE_SUCCESS_ADD,
  ...
  public String edit(
    ...
    String message = i18n.msg(
      request,
      I18n.KEY_MESSAGE_SUCCESS_UPDATE,
      new Object[] { ACCOUNT, account.getName() }
    );
    redirectAttrs.addFlashAttribute(I18n.MESSAGE, message);
  ...
  public String delete(
    ...
    try {
      if (id != 0) {
        ...
        String message = i18n.msg(
          request,
          I18n.KEY_MESSAGE_SUCCESS_DELETE,
          new Object[] { ACCOUNT, account.getName() }
        );
        redirectAttrs.addFlashAttribute(I18n.MESSAGE, message);
      }
