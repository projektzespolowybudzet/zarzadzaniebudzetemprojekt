...
public class TransactionDetailsMapper
  implements RowMapper<TransactionDetailsDTO> {

  /**
   * Map a row of the result set into a TransactionDetailsDTO.
   *
   * @param rs - ResultSet containing the row to map.
   * @param rowNum - the row number to map.
   */
  public TransactionDetailsDTO mapRow(ResultSet rs, int rowNum)
    throws SQLException {
